<!--
This file preserves the ORIGINAL assignment text and setup instructions that
shipped with the upstream course scaffold (aasmundeldhuset/dave3606-project-2026).
It is kept for reference. For a summary of what this fork implements, how to run
it, and the team's design decisions, see the root README.md.

The full project report (design choices and answers to the theory questions) is
committed alongside the code as `Ressurseffektive oblig 1 draft.pdf`.
-->
